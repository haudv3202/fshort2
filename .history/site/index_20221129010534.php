<?php
    ...
    if(isset($_GET['about'])){
        ...
        foreach ($arr as $value){
            ...
            foreach (comment_all($value['id']) as $value3 ){
                $comments2[] = [
                    'name_user_comment2' => account_one_row($value2['id_account'])['name'],
                    'content2' => $value3['content'],
                    'id_post2' => $value3['id_post'],
                    'time_date2' => $value3['create_date'],
                    'avatar_comment2' => account_one_row($value['id_account'])['link_avatar']
                    ];
            }
            $posts_news[] = [
                'id_user_log' => $id_user,
