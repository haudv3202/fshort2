    ...
    <div id="video_detail_mini">
      ...
      <div class="profile_detail_mini_right">
        <div class="avatar_name_icon_video_mini_right">
          ...
          <div class="name_setting_mini_video">
            <div class="name_mini_video">
              <h3>#<?php echo account_one_row($value['id_account'])['id'] ?><?php echo account_one_row($value['id_account'])['name'] ?></h3>
              <h4><span><?php echo account_one_row($value['id_account'])['name'] ?></span><span> 9-7</span></h4>
            </div>
        ...
        <div class="title_mini_video">
          <?php echo $value['title'] ?> <span class="tag_mini_video">#demo #fshort</span>
        </div>
