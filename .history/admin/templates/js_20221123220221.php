<!-- js -->
<script src="./public/src/scripts/core.js"></script>
<script src="./public/src/scripts/script.min.js"></script>
<script src="./public/src/scripts/process.js"></script>
<script src="./public/src/scripts/layout-settings.js"></script>
