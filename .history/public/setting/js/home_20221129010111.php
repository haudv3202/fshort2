       ...
       var Comments_posts = "";
        for (let posts_comment of item.comments) {
          Comments_posts += `
            ...
            <div class="text_logo_name_videos">
                <p>${posts_comment.avatar_comment}<i class='bx bxs-check-circle' style='color:#2e88ff'></i></p>
                <p>${posts_comment.avatar_comment} ~ <i class='bx bx-world'></i></p>
            </div>
        </div>
        <div class="value_comment_user">
            <p>
            ${posts_comment.avatar_comment}
          </p>
        </div>
        `
        }
