...
` + Comments_video + `
    ...
    <div class="input_comment">
      <form action="action="index.php?home" method="post">
        <i class='bx bx-wink-smile'></i>
        <input type="hidden" name="id_post" value="${video_comment.time_date}">
        <input type="hidden" name="id_post" value="${item.id_post}">
        <input type="text" name="content_video_home" required  placeholder="Thêm bình luận">
        <button type="submit" name="submit_comment_video_home"> Đăng</button>
      </form>
    </div>
         </div>
