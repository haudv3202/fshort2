<script>
const array_video_detail = <?php echo json_encode($posts_video); ?>;
console.log(array_video_detail);
...
function About_home(dataabouthome) {
  ...
  if (ListaboutHome) {
    ...
    for (let item of dataabouthome) {
      let commentposts = document.querySelector(".let ListaboutHome = document.querySelector(".about_render_video");");
       var Comments_posts = "";
...
Vieo_detail(array_video_detail);
