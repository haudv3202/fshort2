        ...
        for (let comment of item.comments) {
          Comments += `
            <div class="info_comment_video_page">
                <img src="${comment.avatar_comment}" alt="">
                <div class="text_logo_name_videos">
                <p>${comment.name_user_comment}<i class='bx bxs-check-circle' style='color:#2e88ff'></i></p>
            <p>${comment.time_date} ~ <i class='bx bx-world'></i></p>
        </div>
        </div>
