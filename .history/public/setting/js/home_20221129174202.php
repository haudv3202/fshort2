...
if (ListvideoHome) {
        ...
        ListvideoHome.innerHTML += `
            ...
            <div class="logo_name_videos">
                <img src="${item.avatar}"
                    alt="">
                <div class="text_logo_name_videos">
                    <p><a href="">${item.name}</a><i class='bx bxs-check-circle' style='color:#2e88ff'></i></p>
  ...
  <a href="?detail_video_mini&id_post=_+${item.id_post}"><video  width="50%" preload=""  controls type="video/mp4" loop
