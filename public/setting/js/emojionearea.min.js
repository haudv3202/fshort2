...
(window =
  ...
  (function (a, b) {
    ...
    function o(a, b, c) {
      ...
      return (
        b.uc_base && k > 4
          ? ((h = b.uc_base), (b = b.uc_output.toUpperCase()))
          : (h = b),
        a
          .replace("{name}", c || "")
    ...
    function p(a, b, c) {
      return a.replace(/:?\+?[\w_\-]+:?/g, function (a) {
        ...
        return d
          ? k > 4
            ? o(b, d, a)
            : (k > 3 && (d = d.unicode), o(b, d[d.length - 1], a))
          : c
          ? ""
          : a;
      });
      ...
      if (!b.sprite && b.lasyEmoji[0] && b.lasyEmoji.eq(0).is(".lazy-emoji")) {
        ...
        b.lasyEmoji.each(function () {
          ...
          if (
            (e > c &&
              e < d &&
              b.attr("src", b.data("src")).removeClass("lazy-emoji"),
            e > d)
          )
            return !1;
        }),
      ...
      if (!b.recent || b.recent !== d || c) {
        if (d.length) {
          var e = b.scrollArea.is(".skinnable"),
            ...
            g;
          e ||
            ((f = b.scrollArea.scrollTop()),
            c && b.recentCategory.show(),
            (g = b.recentCategory.is(":visible")
              ? b.recentCategory.height()
              : 0));
          var h = p(d, b.emojiBtnTemplate, !0).split("|").join("");
          if (
            (b.recentCategory.children(".emojibtn").remove(),
            a(h).insertAfter(
              b.recentCategory.children(".emojionearea-category-title")
            ),
          ...
          b.recentFilter.hasClass("active") &&
            b.recentFilter.removeClass("active").next().addClass("active"),
    ...
    function L(b, c, d) {
      (b.options = d = w(d)),
        ...
        (b.emojiTemplate =
          ...
          (b.sprite ? '-{uni}" src="' + h + '"/>' : 'emoji" src="{img}"/>')),
        (b.emojiTemplateAlt = b.sprite
      ...
      var g = c.is("TEXTAREA") || c.is("INPUT") ? "val" : "text",
        ...
        O = G(
          ...
          (o = b.button =
            G("button", G("button-open"), G("button-close")).attr(
              "title",
              d.buttonTitle
            )),
          (r = b.picker =
            G(
              ...
              G(
                ...
                (M = G(
                  "scroll-area",
                  d.tones && !d.search ? G("tones-panel", N) : null,
                  (z = G("emojis-list"))
                ))
              )
            )
        ...
        (a.each(d.filters, function (c, e) {
          ...
          if ("recent" !== c || b.recentEmojis) {
            ...
            do {
              ...
              (g =
                0 === f
                  ? G("category").attr({ name: c, "data-tone": f }).appendTo(P)
                  : G("category-block")
                      .attr({ name: c, "data-tone": f })
                      .appendTo(z)),
                f > 0 &&
                  (g.hide(),
                ...
                (h = p(
                  ...
                  .join("")),
                g.html(h),
                a('<div class="emojionearea-category-title"/>')
                  .text(e.title)
                  .prependTo(g);
            } while (--f > 0);
          }
      ...
      if (
        (M.on("scroll", function () {
          if (!R && (E.call(b), M.is(":not(.skinnable)"))) {
            ...
            e[0] &&
              !e.is(".active") &&
              (u.removeClass("active"), e.addClass("active"));
          }
        }),
        b
          ...
          .on("@emojibtn.click", function (a) {
            i.removeClass("has-placeholder"),
              null !== b.searchSel &&
                (i.focus(), y(i[0], b.searchSel), (b.searchSel = null)),
              b.standalone
                ? (i.html(p(a.data("name"), b.emojiTemplate)),
                  b.trigger("blur"))
                : (x(i[0]), q(p(a.data("name"), b.emojiTemplate))),
          ...
          .on("@!mousedown", function (c, d) {
            return (
              a(d.target).hasClass("search")
                ? ((b.stayFocused = !0),
                  null === b.searchSel && (b.searchSel = x(c[0])))
                : (O.is(".focused") || c.trigger("focus"), d.preventDefault()),
              !1
            );
          })
          .on("@change", function () {
            var a = b.editor.html().replace(/<\/?(?:div|span|p)[^>]*>/gi, "");
            (a.length && !/^<br[^>]*>$/i.test(a)) ||
              b.editor.html((b.content = "")),
              c[g](b.getText());
          })
                    ...
                    var b = function (a, b) {
                        ...
                        if (0 === c.length)
                          a.data("tone") === b && a.hide(),
                            e
                              .filter('[data-filter="' + a.attr("name") + '"]')
                              .hide();
                        else {
                          var d = a.find(
                            '.emojibtn:not([data-name*="' + g + '"])'
                          );
                          d.hide(),
                            c.show(),
        ...
        d.shortcuts &&
          b.on("@keydown", function (a, c) {
            c.ctrlKey ||
              (9 == c.which
                ? (c.preventDefault(), o.click())
                : 27 == c.which &&
                  (c.preventDefault(), o.is(".active") && b.hidePicker()));
          }),
        s(d.events) &&
        ...
        var S = function () {
            ...
            f.sort(),
              ...
              d.textcomplete.placement &&
                "static" ==
                  a(i.data("textComplete").option.appendTo).css("position") &&
                a(i.data("textComplete").option.appendTo).css(
                  "position",
                  "relative"
                );
          },
    ...
    function N(b) {
      ...
      if (((b = w(b)), !M.isLoading))
        if (!e || u(t(e)) < 2) {
          ...
          (d =
            u(c) > 5
              ? M.defaultBase3 + "npm/emojione@" + c
              : u(c) > 4
              ? M.defaultBase3 + "emojione/" + c
              : M.defaultBase + "/" + c),
            a.ajax({
              ...
              success: function () {
                ...
                var d;
                k > 4
                  ? ((M.base = M.defaultBase3 + "emojione/assets/" + c),
                    (d =
                      M.base +
                      "/sprites/emojione-sprite-" +
                      e.emojiSize +
                      ".css"))
                  : ((M.base = M.defaultBase + c + "/assets"),
                    (d = M.base + "/sprites/emojione.sprites.css")),
                  b.sprite &&
                    (document.createStyleSheet
                      ? document.createStyleSheet(d)
                      : a("<link/>", { rel: "stylesheet", href: d }).appendTo(
                          "head"
                        ));
    ...
    (O.prototype.on = function (b, d) {
      ...
      (O.prototype.off = function (b, d) {
        if (b) {
          var e = this.id;
          a.each(
            b.toLowerCase().replace(/_/g, ".").split(" "),
            function (b, f) {
              c[e][f] &&
                !/^@/.test(f) &&
                (d
        ...
        return this.each(function () {
          return this.emojioneArea
            ...
            : (a.data(
                this,
                "emojioneArea",
                (this.emojioneArea = new O(a(this), b))
              ),
              this.emojioneArea);
        });
      }),
      ...
      (a.fn.emojioneAreaText = function (b) {
        ...
        var c = this,
          d = {
            shortnames:
              !b || "undefined" == typeof b.shortnames || b.shortnames,
            emojiTemplate:
              '<img alt="{alt}" class="emojione' +
              (b && b.sprite && k < 3
                ? '-{uni}" src="' + h
        ...
        return (
          ...
          g(function () {
            c.each(function () {
              var b = a(this);
              return (
                b.hasClass("emojionearea-text") ||
                  b
                    .addClass("emojionearea-text")
                    .html(
                      B(
                        b.is("TEXTAREA") || b.is("INPUT") ? b.val() : b.text(),
                        d
                      )
                    ),
                b
