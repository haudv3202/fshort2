<script>
  ...
  <a href="?detail_video_mini&id_post=${item.id_post}" ><span class="resize_video"><video  width="100%" onplay="getCurTime();" id="Video" controls type="video/mp4" loop
            src="${item.link}"></video></span></a>
