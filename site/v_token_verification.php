            ...
            <div class="col-md-6 contents">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="alert alert-success" role="alert">Nhập token để đổi mật khẩu</div>
                        <form action="#" method="post">
                            <div class="form-group first">
                                <label for="username">Token</label>
                                <input type="text" name="token" class="form-control" id="username">
                            </div>
                            <input type="submit" name="token_submit" value="Xác minh" class="btn text-white btn-block btn-primary">
